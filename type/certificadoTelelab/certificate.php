...
certificate_print_text($pdf, $x + 40, $y + 20, 'C', 'freeserif', '', 20, "O Departamento de Doenças Sexualmente Transmissíveis, Aids e Hepatites Virais certifica 
...
em <b>".str_replace(" ", " de ", certificate_get_date($certificate, $certrecord, $course))."</b>, com carga horária de <b>15 horas</b>.", 200);


certificate_print_text($pdf, $x, $y+124, 'C', 'freeserif', '', 10, "A autenticidade deste documento pode ser verificada em \"www.telelab.aids.gov.br/verificar\" informando a senha: ".certificate_get_code($certificate, $certrecord));
